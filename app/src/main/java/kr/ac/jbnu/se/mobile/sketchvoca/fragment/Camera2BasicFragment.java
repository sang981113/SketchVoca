...
package kr.ac.jbnu.se.mobile.sketchvoca.fragment;
...
import kr.ac.jbnu.se.mobile.sketchvoca.AutoFitTextureView;
...
public class Camera2BasicFragment extends Fragment
    ...
    private static class ImageUpLoader implements Runnable {
        ...
        public void run() {
            ...
            StorageReference profileImagesRef = storageRef.child("users/"+ user.getUid() +"/profile.jpg");

            UploadTask uploadTask = profileImagesRef.putBytes(bytes);
